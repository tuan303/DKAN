...
export default function Login() {
  ...
  return (
    <div className="bg-background text-on-background min-h-screen flex antialiased">
      {/* Panel trái: chỉ đặt ảnh trường, phủ kín khung. Nền navy làm màu chờ
          trong lúc ảnh tải, phòng khi ảnh không tải được. */}
      <div className="hidden lg:block lg:w-1/2 relative bg-primary-darker overflow-hidden">
        <img
